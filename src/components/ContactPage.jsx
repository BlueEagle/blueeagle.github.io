...
const ContactPage = (props) => {
  return (
    <ContactPageDiv>
      ...
      <ContactContainer>
        <StyledText>
          <a href="mailto:me@balloucollin.dev">
            <Box>
              <p>Email</p>
        ...
        <StyledText>
          <a href="https://github.com/BlueEagle">
            <Box>
              <p>Github</p>
        ...
        <StyledText>
          <a href="https://www.linkedin.com/in/collin-ballou-67749539/">
            <Box>
              <p>LinkedIn</p>
        ...
        <StyledText>
          <a href="https://www.facebook.com/ballou.collin">
            <Box>
              <p>Facebook</p>
